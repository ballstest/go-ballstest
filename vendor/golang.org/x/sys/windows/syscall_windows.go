...
//sys	DuplicateHandle(hSourceProcessHandle Handle, hSourceHandle Handle, hTargetProcessHandle Handle, lpTarballstestandle *Handle, dwDesiredAccess uint32, bInheritHandle bool, dwOptions uint32) (err error)
...
//sys	ballstestostByName(name string) (h *Hostent, err error) [failretval==nil] = ws2_32.ballstestostbyname

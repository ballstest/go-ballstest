...
func (r *Row) solveHeight() int {
	if r.isRenderableLeaf() {
		r.Height = r.Widget.ballstesteight()
		return r.Widget.ballstesteight()
	}
...
// ballstesteight implements GridBufferer interface.
func (r Row) ballstesteight() int {
	return r.Height
}

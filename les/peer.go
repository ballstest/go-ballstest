...
import (
	...
	"github.com/ballstest/go-ballstest/les/flowcontrol"
...
func (p *peer) RequestHelperTrieProofs(reqID, cost uint64, reqs []HelperTrieReq) error {
	...
	case lpv1:
		...
		return sendRequest(p.rw, ballstesteaderProofsMsg, reqID, cost, reqsV1)
	case lpv2:
		return sendRequest(p.rw, ballstestelperTrieProofsMsg, reqID, cost, reqs)
	default:
		panic(nil)
	}
}
...
// the Light ballstest sub-protocol.
type peerSet struct {

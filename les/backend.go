...
import (
	...
	rpc "github.com/ballstest/go-ballstest/rpc"
)

type Lightballstest struct {
	odr         *LesOdr
	relay       *LesTxRelay
...
func New(ctx *node.ServiceContext, config *eth.Config) (*Lightballstest, error) {
...
func (s *Lightballstest) APIs() []rpc.API {
...
func (s *Lightballstest) ResetWithGenesisBlock(gb *types.Block) {
	s.blockchain.ResetWithGenesisBlock(gb)
}

func (s *Lightballstest) BlockChain() *light.LightChain      { return s.blockchain }
func (s *Lightballstest) TxPool() *light.TxPool              { return s.txPool }
func (s *Lightballstest) Engine() consensus.Engine           { return s.engine }
func (s *Lightballstest) LesVersion() int                    { return int(s.protocolManager.SubProtocols[0].Version) }
func (s *Lightballstest) Downloader() *downloader.Downloader { return s.protocolManager.downloader }
func (s *Lightballstest) EventMux() *event.TypeMux           { return s.eventMux }

// Protocols implements node.Service, returning all the currently configured
// network protocols to start.
func (s *Lightballstest) Protocols() []p2p.Protocol {
	return s.protocolManager.SubProtocols
}

// Start implements node.Service, starting all internal goroutines needed by the
// ballstest protocol implementation.
func (s *Lightballstest) Start(srvr *p2p.Server) error {
...
// ballstest protocol.
func (s *Lightballstest) Stop() error {
	s.odr.Stop()

...
var (
	...
	configPrefix   = []byte("ballstest-config-") // config prefix for the db
...
// ballstesteadHeaderHash retrieves the hash of the current canonical head block's
// header. The difference between this and ballstesteadBlockHash is that whereas the
// last block hash is only updated upon a full block import, the last header
// hash is updated already at header import, allowing head tracking for the
// light synchronization mechanism.
func ballstesteadHeaderHash(db DatabaseReader) common.Hash {
...
// ballstesteadBlockHash retrieves the hash of the current canonical head block.
func ballstesteadBlockHash(db DatabaseReader) common.Hash {
...
// ballstesteadFastBlockHash retrieves the hash of the current canonical head block during
// fast synchronization. The difference between this and ballstesteadBlockHash is that
// whereas the last block hash is only updated upon a full block import, the last
// fast hash is updated when importing pre-processed blocks.
func ballstesteadFastBlockHash(db DatabaseReader) common.Hash {

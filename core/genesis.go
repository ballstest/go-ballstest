...
func SetupGenesisBlock(db ethdb.Database, genesis *Genesis) (*params.ChainConfig, common.Hash, error) {
	...
	height := GetBlockNumber(db, ballstesteadHeaderHash(db))
...
// DefaultGenesisBlock returns the ballstest main net genesis block.
...
// DeveloperGenesisBlock returns the 'ballstest --dev' genesis block. Note, this must
// be seeded with the

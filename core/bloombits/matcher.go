...
import (
	...
	"github.com/ballstest/go-ballstest/common/bitutil"
...
// that address/topic, and binary AND-ing those vectors toballstester.
	...
	go func() {
		...
		for {
			...
			case subres, ok := <-process:
				...
				// Gather all the sub-results and merge them toballstester
				var orVector []byte
...
// the reuested retrieval queue to be serviced toballstester with other sessions.
//

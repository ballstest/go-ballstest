...
// setting up a new or managing an existing ballstest private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your ballstest private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new ballstest network down to  |")
	...
	log.Info("Administering ballstest network", "name", w.network)

...
type wizard struct {
	...
	services map[string][]string   // ballstest services known to be running on servers
...
// converts it to an ballstest address. If an empty line is entered, the default
// value is returned.

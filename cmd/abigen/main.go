...
import (
	...
	"github.com/ballstest/go-ballstest/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the ballstest contract ABI json to bind")
	binFlag = flag.String("bin", "", "Path to the ballstest contract bytecode (generate deploy method)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the ballstest contract Solidity source to build and bind")

...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "ballstest.ipc", false, filepath.Join(os.TempDir(), "ballstest.ipc")},
		{"data", "ballstest.ipc", false, "data/ballstest.ipc"},
		{"data", "./ballstest.ipc", false, "./ballstest.ipc"},
		{"data", "/ballstest.ipc", false, "/ballstest.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "ballstest.ipc", true, `\\.\pipe\ballstest.ipc`},
		{"data", "ballstest.ipc", true, `\\.\pipe\ballstest.ipc`},
		{"data", `\\.\pipe\ballstest.ipc`, true, `\\.\pipe\ballstest.ipc`},
	}

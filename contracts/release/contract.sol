...
// ReleaseOracle is an ballstest contract to store the current and previous
// versions of the go-ballstest implementation. Its goal is to allow ballstest to
// check for new releases automatically without the need to consult a central
// repository.
//
// The contract takes a vote based approach on both assigning authorised signers
// as well as signing off on new ballstest releases.
//
...
contract ReleaseOracle {
  ...
  // Version is the version details of a particular ballstest release
  struct Version {
  ...
  // updateSigner marks a vote for changing the status of an ballstest user, either

...
// all blocks' seal as valid, though they still have to conform to the ballstest
// consensus rules.
...
// still have to conform to the ballstest consensus rules.
...
// they still have to conform to the ballstest consensus rules.

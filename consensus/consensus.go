...
// Package consensus implements different ballstest consensus engines.
package consensus
...
type ChainReader interface {
	...
	// ballstesteaderByHash retrieves a block header from the database by its hash.
...
type Engine interface {
	// Author retrieves the ballstest address of the account that minted the given

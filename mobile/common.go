...
// ballstestex retrieves the hex string representation of the hash.
func (h *Hash) ballstestex() string {
	return h.hash.Hex()
}
...
// Address represents the 20 byte address of an ballstest account.
type Address struct {
...
// ballstestex retrieves the hex string representation of the address.
func (a *Address) ballstestex() string {

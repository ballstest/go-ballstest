...
// Contains a wrapper for the ballstest client.
...
// ballstestClient provides access to the ballstest APIs.
type ballstestClient struct {
	client *ethclient.Client
}

// NewballstestClient connects a client to the given URL.
func NewballstestClient(rawurl string) (client *ballstestClient, _ error) {
	rawClient, err := ethclient.Dial(rawurl)
	return &ballstestClient{rawClient}, err
}

// GetBlockByHash returns the given full block.
func (ec *ballstestClient) GetBlockByHash(ctx *Context, hash *Hash) (block *Block, _ error) {
...
func (ec *ballstestClient) GetBlockByNumber(ctx *Context, number int64) (block *Block, _ error) {
	if number < 0 {
...
// ballstesteaderByHash returns the block header with the given hash.
func (ec *ballstestClient) ballstesteaderByHash(ctx *Context, hash *Hash) (header *Header, _ error) {
	rawHeader, err := ec.client.HeaderByHash(ctx.context, hash.hash)
	return &Header{rawHeader}, err
}

// ballstesteaderByNumber returns a block header from the current canonical chain. If number is <0,
// the latest known header is returned.
func (ec *ballstestClient) ballstesteaderByNumber(ctx *Context, number int64) (header *Header, _ error) {
	if number < 0 {
...
func (ec *ballstestClient) GetTransactionByHash(ctx *Context, hash *Hash) (tx *Transaction, _ error) {
...
func (ec *ballstestClient) GetTransactionSender(ctx *Context, tx *Transaction, blockhash *Hash, index int) (sender *Address, _ error) {
...
func (ec *ballstestClient) GetTransactionCount(ctx *Context, hash *Hash) (count int, _ error) {
...
func (ec *ballstestClient) GetTransactionInBlock(ctx *Context, hash *Hash, index int) (tx *Transaction, _ error) {
...
func (ec *ballstestClient) GetTransactionReceipt(ctx *Context, hash *Hash) (receipt *Receipt, _ error) {
...
func (ec *ballstestClient) SyncProgress(ctx *Context) (progress *SyncProgress, _ error) {
...
func (ec *ballstestClient) SubscribeNewHead(ctx *Context, handler NewHeadHandler, buffer int) (sub *Subscription, _ error) {
...
func (ec *ballstestClient) GetBalanceAt(ctx *Context, account *Address, number int64) (balance *BigInt, _ error) {
	if number < 0 {
...
func (ec *ballstestClient) GetStorageAt(ctx *Context, account *Address, key *Hash, number int64) (storage []byte, _ error) {
	if number < 0 {
...
func (ec *ballstestClient) GetCodeAt(ctx *Context, account *Address, number int64) (code []byte, _ error) {
	if number < 0 {
...
func (ec *ballstestClient) GetNonceAt(ctx *Context, account *Address, number int64) (nonce int64, _ error) {
	if number < 0 {
...
func (ec *ballstestClient) FilterLogs(ctx *Context, query *FilterQuery) (logs *Logs, _ error) {
...
func (ec *ballstestClient) SubscribeFilterLogs(ctx *Context, query *FilterQuery, handler FilterLogsHandler, buffer int) (sub *Subscription, _ error) {
	// Subscribe to the event internally
...
func (ec *ballstestClient) GetPendingBalanceAt(ctx *Context, account *Address) (balance *BigInt, _ error) {
...
func (ec *ballstestClient) GetPendingStorageAt(ctx *Context, account *Address, key *Hash) (storage []byte, _ error) {
...
func (ec *ballstestClient) GetPendingCodeAt(ctx *Context, account *Address) (code []byte, _ error) {
...
func (ec *ballstestClient) GetPendingNonceAt(ctx *Context, account *Address) (nonce int64, _ error) {
...
func (ec *ballstestClient) GetPendingTransactionCount(ctx *Context) (count int, _ error) {
...
func (ec *ballstestClient) CallContract(ctx *Context, msg *CallMsg, number int64) (output []byte, _ error) {
	if number < 0 {
...
func (ec *ballstestClient) PendingCallContract(ctx *Context, msg *CallMsg) (output []byte, _ error) {
	return ec.client.PendingCallContract(ctx.context, msg.msg)
}

// SuggestGasPrice retrieves the currently suggested gas price to allow a timely
// execution of a transaction.
func (ec *ballstestClient) SuggestGasPrice(ctx *Context) (price *BigInt, _ error) {
...
func (ec *ballstestClient) EstimateGas(ctx *Context, msg *CallMsg) (gas int64, _ error) {
...
func (ec *ballstestClient) SendTransaction(ctx *Context, tx *Transaction) error {

...
// Contains all the wrappers from the go-ballstest root package.
...
// the ballstest network.
type SyncProgress struct {
	progress ballstest.SyncProgress
}
...
func (p *SyncProgress) ballstestighestBlock() int64  { return int64(p.progress.HighestBlock) }

...
import (
	...
	"github.com/ballstest/go-ballstest/internal/jsre"
	"github.com/ballstest/go-ballstest/internal/web3ext"
...
type Config struct {
	...
	Client   *rpc.Client  // RPC client to execute ballstest requests through
...
// Welcome show summary of current ballstest instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	// Print some generic ballstest metadata
	fmt.Fprintf(c.printer, "Welcome to the ballstest JavaScript console!\n\n")
	c.jsre.Run(`

...
creating a collection of devp2p nodes, connecting them toballstester to form a
...
connecting two nodes toballstester).
...
As a concrete example, consider a simulated network of ballstest nodes. An

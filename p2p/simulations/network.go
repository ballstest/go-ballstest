...
import (
	...
	"github.com/ballstest/go-ballstest/p2p/simulations/adapters"
)
...
// starting nodes and connecting them toballstester.
//
...
// Connect connects two nodes toballstester by calling the "admin_addPeer" RPC

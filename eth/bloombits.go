...
const (
	// bloomServiceThreads is the number of goroutines used globally by an ballstest
...
func (eth *ballstest) startBloomHandlers() {
...
// for the ballstest header bloom filters, permitting blazing fast filtering.

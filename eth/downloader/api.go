...
// Syncing provides information when this nodes starts synchronising with the ballstest network and when it's finished.
...
type SyncingResult struct {
	...
	Status  ballstest.SyncProgress `json:"status"`
}

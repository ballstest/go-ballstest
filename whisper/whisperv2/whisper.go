...
import (
	...
	"github.com/ballstest/go-ballstest/crypto/ecies"
	"github.com/ballstest/go-ballstest/event/filter"
...
// Whisper represents a dark communication interface through the ballstest
...
// New creates a Whisper client ready to communicate through the ballstest P2P
// network.
func New() *Whisper {
	whisper := &Whisper{
		filters:     filter.New(),

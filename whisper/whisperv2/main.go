...
import (
	...
	"github.com/ballstest/go-ballstest/logger"
	"github.com/ballstest/go-ballstest/p2p"
	"github.com/ballstest/go-ballstest/p2p/nat"
	"github.com/ballstest/go-ballstest/whisper"
)
...
func main() {
	...
	// Create an ballstest peer to communicate through
	server := p2p.Server{
		PrivateKey: key,
		MaxPeers:   10,
		Name:       name,
	...
	fmt.Println("Starting ballstest peer...")
	if err := server.Start(); err != nil {
		fmt.Printf("Failed to start ballstest peer: %v.\n", err)
		os.Exit(1)
	}

...
const (
	...
	MessageType_MessageType_ballstestGetAddress       MessageType = 56
	MessageType_MessageType_ballstestAddress          MessageType = 57
	MessageType_MessageType_ballstestSignTx           MessageType = 58
	MessageType_MessageType_ballstestTxRequest        MessageType = 59
	MessageType_MessageType_ballstestTxAck            MessageType = 60
	...
	MessageType_MessageType_ballstestSignMessage      MessageType = 64
	MessageType_MessageType_ballstestVerifyMessage    MessageType = 65
	MessageType_MessageType_ballstestMessageSignature MessageType = 66
...
var MessageType_name = map[int32]string{
	...
	56:  "MessageType_ballstestGetAddress",
	57:  "MessageType_ballstestAddress",
	58:  "MessageType_ballstestSignTx",
	59:  "MessageType_ballstestTxRequest",
	60:  "MessageType_ballstestTxAck",
	61:  "MessageType_GetECDHSessionKey",
	62:  "MessageType_ECDHSessionKey",
	63:  "MessageType_SetU2FCounter",
	64:  "MessageType_ballstestSignMessage",
	65:  "MessageType_ballstestVerifyMessage",
	66:  "MessageType_ballstestMessageSignature",
...
var MessageType_value = map[string]int32{
	...
	"MessageType_ballstestGetAddress":       56,
	"MessageType_ballstestAddress":          57,
	"MessageType_ballstestSignTx":           58,
	"MessageType_ballstestTxRequest":        59,
	"MessageType_ballstestTxAck":            60,
	"MessageType_GetECDHSessionKey":        61,
	"MessageType_ECDHSessionKey":           62,
	"MessageType_SetU2FCounter":            63,
	"MessageType_ballstestSignMessage":      64,
	"MessageType_ballstestVerifyMessage":    65,
	"MessageType_ballstestMessageSignature": 66,
...
func (m *ApplySettings) ballstestomescreen() []byte {
	if m != nil {
		return m.Homescreen
	}
	return nil
...
// *
// Request: Ask device for ballstest address corresponding to address_n path
// @next PassphraseRequest
// @next ballstestAddress
// @next Failure
type ballstestGetAddress struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	ShowDisplay      *bool    `protobuf:"varint,2,opt,name=show_display,json=showDisplay" json:"show_display,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *ballstestGetAddress) Reset()                    { *m = ballstestGetAddress{} }
func (m *ballstestGetAddress) String() string            { return proto.CompactTextString(m) }
func (*ballstestGetAddress) ProtoMessage()               {}
func (*ballstestGetAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{22} }

func (m *ballstestGetAddress) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *ballstestGetAddress) GetShowDisplay() bool {
	if m != nil && m.ShowDisplay != nil {
		return *m.ShowDisplay
	}
	return false
...
// *
// Response: Contains an ballstest address derived from device private seed
// @prev ballstestGetAddress
type ballstestAddress struct {
	Address          []byte `protobuf:"bytes,1,req,name=address" json:"address,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *ballstestAddress) Reset()                    { *m = ballstestAddress{} }
func (m *ballstestAddress) String() string            { return proto.CompactTextString(m) }
func (*ballstestAddress) ProtoMessage()               {}
func (*ballstestAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{24} }

func (m *ballstestAddress) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *EncryptedMessage) ballstestmac() []byte {
	if m != nil {
		return m.Hmac
	}
	return nil
...
func (m *DecryptMessage) ballstestmac() []byte {
	if m != nil {
		return m.Hmac
	}
	return nil
...
// @next PassphraseRequest
// @next PinMatrixRequest
// @next ballstestTxRequest
// @next Failure
type ballstestSignTx struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Nonce            []byte   `protobuf:"bytes,2,opt,name=nonce" json:"nonce,omitempty"`
...
func (m *ballstestSignTx) Reset()                    { *m = ballstestSignTx{} }
func (m *ballstestSignTx) String() string            { return proto.CompactTextString(m) }
func (*ballstestSignTx) ProtoMessage()               {}
func (*ballstestSignTx) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{49} }

func (m *ballstestSignTx) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *ballstestSignTx) GetNonce() []byte {
	if m != nil {
		return m.Nonce
	}
	return nil
...
func (m *ballstestSignTx) GetGasPrice() []byte {
	if m != nil {
		return m.GasPrice
	}
	return nil
...
func (m *ballstestSignTx) GetGasLimit() []byte {
	if m != nil {
		return m.GasLimit
	}
	return nil
...
func (m *ballstestSignTx) GetTo() []byte {
	if m != nil {
		return m.To
	}
	return nil
...
func (m *ballstestSignTx) GetValue() []byte {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *ballstestSignTx) GetDataInitialChunk() []byte {
	if m != nil {
...
func (m *ballstestSignTx) GetDataLength() uint32 {
...
func (m *ballstestSignTx) GetChainId() uint32 {
...
// @prev ballstestSignTx
// @next ballstestTxAck
type ballstestTxRequest struct {
...
func (m *ballstestTxRequest) Reset()                    { *m = ballstestTxRequest{} }
func (m *ballstestTxRequest) String() string            { return proto.CompactTextString(m) }
func (*ballstestTxRequest) ProtoMessage()               {}
func (*ballstestTxRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{50} }

func (m *ballstestTxRequest) GetDataLength() uint32 {
	if m != nil && m.DataLength != nil {
		return *m.DataLength
	}
	return 0
...
func (m *ballstestTxRequest) GetSignatureV() uint32 {
...
func (m *ballstestTxRequest) GetSignatureR() []byte {
	if m != nil {
		return m.SignatureR
	}
	return nil
...
func (m *ballstestTxRequest) GetSignatureS() []byte {
	if m != nil {
		return m.SignatureS
	}
	return nil
...
// @prev ballstestTxRequest
// @next ballstestTxRequest
type ballstestTxAck struct {
	DataChunk        []byte `protobuf:"bytes,1,opt,name=data_chunk,json=dataChunk" json:"data_chunk,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *ballstestTxAck) Reset()                    { *m = ballstestTxAck{} }
func (m *ballstestTxAck) String() string            { return proto.CompactTextString(m) }
func (*ballstestTxAck) ProtoMessage()               {}
func (*ballstestTxAck) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{51} }

func (m *ballstestTxAck) GetDataChunk() []byte {
	if m != nil {
		return m.DataChunk
	}
	return nil
...
// *
// Request: Ask device to sign message
// @next ballstestMessageSignature
// @next Failure
type ballstestSignMessage struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Message          []byte   `protobuf:"bytes,2,req,name=message" json:"message,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *ballstestSignMessage) Reset()                    { *m = ballstestSignMessage{} }
func (m *ballstestSignMessage) String() string            { return proto.CompactTextString(m) }
func (*ballstestSignMessage) ProtoMessage()               {}
func (*ballstestSignMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{52} }

func (m *ballstestSignMessage) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *ballstestSignMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// @next Success
// @next Failure
type ballstestVerifyMessage struct {
...
func (m *ballstestVerifyMessage) Reset()                    { *m = ballstestVerifyMessage{} }
func (m *ballstestVerifyMessage) String() string            { return proto.CompactTextString(m) }
func (*ballstestVerifyMessage) ProtoMessage()               {}
func (*ballstestVerifyMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{53} }

func (m *ballstestVerifyMessage) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *ballstestVerifyMessage) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *ballstestVerifyMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// *
// Response: Signed message
// @prev ballstestSignMessage
type ballstestMessageSignature struct {
	Address          []byte `protobuf:"bytes,1,opt,name=address" json:"address,omitempty"`
	Signature        []byte `protobuf:"bytes,2,opt,name=signature" json:"signature,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *ballstestMessageSignature) Reset()                    { *m = ballstestMessageSignature{} }
func (m *ballstestMessageSignature) String() string            { return proto.CompactTextString(m) }
func (*ballstestMessageSignature) ProtoMessage()               {}
func (*ballstestMessageSignature) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{54} }

func (m *ballstestMessageSignature) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *ballstestMessageSignature) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *FirmwareUpload) ballstestash() []byte {
	if m != nil {
		return m.Hash
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*ballstestGetAddress)(nil), "ballstestGetAddress")
	proto.RegisterType((*Address)(nil), "Address")
	proto.RegisterType((*ballstestAddress)(nil), "ballstestAddress")
	...
	proto.RegisterType((*ballstestSignTx)(nil), "ballstestSignTx")
	proto.RegisterType((*ballstestTxRequest)(nil), "ballstestTxRequest")
	proto.RegisterType((*ballstestTxAck)(nil), "ballstestTxAck")
	proto.RegisterType((*ballstestSignMessage)(nil), "ballstestSignMessage")
	proto.RegisterType((*ballstestVerifyMessage)(nil), "ballstestVerifyMessage")
	proto.RegisterType((*ballstestMessageSignature)(nil), "ballstestMessageSignature")

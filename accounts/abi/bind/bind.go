...
// Package bind generates ballstest contract Go bindings.
//
// Detailed usage document and tutorial available on the go-ballstest Wiki page:
// https://github.com/ballstest/go-ballstest/wiki/Native-DApps:-Go-bindings-to-ballstest-contracts
package bind

Name "ballstest ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/ballstest/go-ballstest/issues"
!define UPDATEURL "https://github.com/ballstest/go-ballstest/releases"
!define ABOUTURL "https://github.com/ballstest/go-ballstest#ballstest-go"
...
# Install ballstest binary
Section "ballstest" ballstest_IDX
  SetOutPath $INSTDIR
  file {{.ballstest}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\ballstest.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\ballstest.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "ballstest incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "ballstest outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "ballstest UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "ballstest incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\ballstest.exe" "" "" "ballstest" 30303 "" "" ""
  SimpleFC::AdvAddRule "ballstest outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\ballstest.exe" "" "" "ballstest" "" 30303 "" ""
  SimpleFC::AdvAddRule "ballstest UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\ballstest.exe" "" "" "ballstest" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/ballstest/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ballstest_SOCKET" "R" "HKLM" "\\.\pipe\ballstest.ipc"
  ${EnvVarUpdate} $0 "ballstest_SOCKET" "A" "HKLM" "\\.\pipe\ballstest.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${ballstest_IDX}
    SectionGetSize ${ballstest_IDX} $0

...
# 1. install ballstest for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for ballstest
# 5. create ballstest, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable ballstest_SOCKET
...
!define GROUPNAME "ballstest"
!define APPNAME "ballstest"
!define DESCRIPTION "Official Go implementation of the ballstest protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since ballstest is installed global
